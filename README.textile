...
- Play! Framework with an older release of Hibernate to support JDBC < 4 (the @-hh@ package)

As this branch will be kept up-to-date with the latest Play! Framework from upstream, it will be _rebased_ often, so be away that
if you intend to _pull_ from it, you will have history rewrites.

Once you have checked out this branch, you can build the debian packages with:

bc. fakeroot ./debian/rules clean binary
