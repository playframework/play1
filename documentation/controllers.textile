...
If the HTTP parameter corresponding to the action method argument is not found, the corresponding method argument is set to null. If a value is found but it can't be properly cast to the required Java type, an exception is thrown.
