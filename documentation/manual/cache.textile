...
To create high-performance systems, sometimes you need to cache data. Play provides a cache infrastructure that you may use via: 
  - the cache API
  - the @cacheFor@ to annotate your actions
