...
The "module repository":http://www.playframework.com/modules identifies all modules contributed by the community. A module can have several versions. You have to check the module’s documentation for which version you need to use for your framework version.
...
# A module name that matches the regular expression <code>[a-zA-Z]+</code>.
# "Module documentation":#documentation that explains what the module is for and how to use it.
...
# A license file, such as the open-source license in the Play distribution’s @COPYING@ file.
...
# On "http://www.playframework.com/modules":http://www.playframework.com/modules, under _Developer login_ enter @https://www.google.com/accounts/o8/id@ and click the _Login_ button.
...
# log in to "http://www.playframework.com/modules":http://www.playframework.com/modules under _Developer login_
# browse to your module’s page, via the link on "http://www.playframework.com/modules/developers":http://www.playframework.com/modules/developers under _Your modules_
