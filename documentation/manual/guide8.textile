...
Now go to "http://localhost:9000/logout":http://localhost:9000/logout to log out and you can try one of the users imported in **initial-data.yml** file, like **bob@gmail.com/secret**.
...
Now we can build an administration menu that depends of the user role. Update the **yabe/views/admin.html** to integrate a top level menu:
