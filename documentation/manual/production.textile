...
For your production server, it’s usually a bad idea to let Hibernate automatically ALTER your production's schema and data… 
...
Let’s start out the same Play application two times: one on port 9999 and one on port 9998.
