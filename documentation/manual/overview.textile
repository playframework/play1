...
It is so fun that you can even work with a simple text editor and skip a full featured Java IDE if want (however it integrate nicely with any Java IDE).
...
JPA is surrely the best ORM API available for Java. If you know it you will be amazed how simpler it become with play. Nothing to configure, play will automatically startthe JPA Entity Manager using Hibernate and magically synchonize it while code reloading. 
