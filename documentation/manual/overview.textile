...
HTTP, the Request/Response pattern, REST, content-type negotiation and URI are all major concepts for the Play! framework. 
...
A plugin architecture lets you combine a Web application with many other Web applications, and reuse Java code, templates or resources like Javascript and CSS.
