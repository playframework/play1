...
bc. public class MyEntity extends JPASupport {
  @CollectionOfElements
  public List<MyEnum> listOfThing;
  @CollectionOfElements
...
"myEnumId1","myEnumId2" for the listOfThing and "string1","string2" for the listOfString. Per definition, this is what you should first customize in your CRUD module.

h2. <a>Limitation</a>

The crud module will show the relation that are unidirectional in only one entity, the one that is does not have the mappedBy attribute.