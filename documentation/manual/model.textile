...
The Play distribution includes JDBC drivers for HSQLDB and MySQL in the **$PLAY_HOME/framework/lib/** directory. If you are using a PostgreSQL or Oracle database, for example, then you should add the JDBC driver library there, or in your application’s **lib/** directory.
