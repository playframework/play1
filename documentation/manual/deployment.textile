...
A Play! application can be run using the standard embedded server: Mina, a high performance and high scalability network server. Different "modules":http://playframework.org/modules allows you to use a different server (Grizzly, Netty, etc...) as well. 
