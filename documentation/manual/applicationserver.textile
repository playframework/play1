...
It is advised to "isolate" your Play! application from the other applications to avoid version mismatch between the application libraries. This step is not standartize by the JEE / Servlet Container specification, it is therefore vendor specific.
