...
However, using a modern Java IDE provides cool productivity features like auto-completion, on-the-fly compilation, assisted refactoring and debugging. Play supports the "Netbeans":http://www.netbeans.org and "Eclipse":http://www.eclipse.org platforms.
