...
"Eclipse":#eclipse | "Netbeans":#netbeans | "Textmate":#textmate | "Other IDEs":#custom
...
However using a modern Java IDE provides cool productivity features like auto-completion, on the fly compilation, assisted refactoring and debugging. Play supports "Netbeans":http://www.netbeans.org and "Eclipse":http://www.eclipse.org platforms.
...
As play applications are standard Java applications you won't need any specific plugin to work with your preferred editor. 
...
If you have some modules enabled, you will need to add all modules librairies (from the $module/lib directory) to the classpath as well.
