...
So, for instance version 1.0 of the "Play PDF module":http://www.playframework.com/modules/pdf is expressed like this:
...
By default, Play will search for **JAR** dependencies in the "central Maven repository":http://repo1.maven.org/maven2/, and will search for **Play modules** in the "central Play modules repository":http://www.playframework.com/modules. 
