...
The Play framework is designed with security in mind - but it is impossible to prevent developers using the framework to mess up and open holes. The guide describes the common security issues in web applications and how avoid them in Play applications.
...
That’s what sessions are for: a set of cookies stored in the user’s browser that identify him to the web site, and provide other information your web application may choose to store there rather than in the data layer; for example the language.
