...
To prevent this attack, the first thing to do is to use GET and POST methods appropriately. That means that only POST method should be used to change the application’s state.
