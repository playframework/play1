...
p(note). **Note** that you can override other methods as well as customize how the application should react to authentication events (onAuthenticated, onDisconnected).
