...
The simple **Secure** module help you to set up basic authentication and authorization management to your application. It provides a simple **controllers.Secure** controller that defines a set of inteceptors that you can easily add to your own controllers using the **@With** annotation.
...
p(note). **Note** that it's not required to use the default routes file. You can also define your own routes, or mix both.
