...
**Play 1.1** is an important release for Play framework. 
...
Combined with the **waitFor(…)** feature, you can build high performance non-blocking applications that mashup existing applications:
