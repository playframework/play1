...
The goal of the module0 repository is to centralize all contributed modules for the Play framework, and allow easy installation. The new modules related commands are:
...
The **@@** syntax, that allow to reverse an action to an **absolute** URL, in now available in tag parameters. For example:
