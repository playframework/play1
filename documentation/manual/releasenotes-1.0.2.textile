...
p(note). **Play 1.0.2** is a maintenance release and is fully compatible with the 1.0 series. If you encounter any problems please ask us on the Google Group.
...
The module repository’s goal is to centralize all contributed modules for the Play framework, and allow easy installation. The new modules related commands are:
