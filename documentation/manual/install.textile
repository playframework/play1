...
The play command line utility use python. So it should work out of the box on any UNIX system. If you'are running Windows, don't worry, a python runtime is bundled with the framework.
...
Play framework is ready to use.
