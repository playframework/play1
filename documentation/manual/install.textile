...
# Install Java.
# Download the latest "Play binary package":http://download.playframework.org/ and extract the archive.
...
# Download the latest "Play binary package":http://download.playframework.org/ and extract it in @/Applications@.
