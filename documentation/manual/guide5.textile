...
Because we have now more error messages, modify the way we display errors in the **show.html** template:
...
p(note). Typically for more complex forms, error messages are not managed this way but externalized in the **messages** file. We'll see that later.
