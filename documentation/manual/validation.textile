...
h2. <a name="how">How does it work?</a>
...
h2. <a name="messages">Retrieving error messages</a>
...
h2. <a name="displaying">Displaying errors in the template</a>
...
h2. <a name="annotations">Using annotations</a>
...
h2. <a name="objects">Validating objects</a>
