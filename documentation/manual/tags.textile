...
The field tag is an helper, based on the spirit of the Don’t Repeat Yourself spirit. It works this way:
...
Includes another template. All variables of the current template are directly available in the included template.
...
The tag defines implicit variables in his body. The variable names are prefixed with the loop variable name.
