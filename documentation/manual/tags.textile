...
Note that the output will be escaped to prevent XSS issues. If you really want to display the raw data, specify the **raw** attribute:

bc. #{get 'someData', raw:true /} 

Or include the **get** call into a **#{verbatim /}** tag.
