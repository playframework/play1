...
p(note). If you want to search the standard play Java extensions, you should look at the "JavaDoc":/@api/play/templates/JavaExtensions.html
...
Insert a **form** tag. HTTP method is guessed from the route, and defaults to POST. If there are both GET and POST routes configured for the URL, the tag will default to using the first route defined in routes.  
...
The field tag is an helper, based on the spirit of the Don't Repeat
Yourself spirit. It works this way:
