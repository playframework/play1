...
Play gives you a way to test directly the controller part of the application using JUnit. We call these tests **'Functional tests'**. This is because we want to test complete functionalities of the web application.
