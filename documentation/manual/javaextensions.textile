...
h3. <a name="truncate">truncate(length, ending)</a>

Truncates a string if it is longer than the specified length. Truncated strings will end by default with an ellipsis ("..."). Returns: @String@.

bc. ${"Lorem ipsum dolor sit amet, consectetur adipiscing elit.".truncate(25)}
Lorem ipsum dolor sit ...

${"Lorem ipsum dolor sit amet, consectetur adipiscing elit.".truncate(25, "... (continued)")}
Lorem ipsu... (continued)
