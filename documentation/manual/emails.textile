...
bc. <html><body><head>...</head><body><img src="mycompany.com/images"/><p>Hello ${user.name},
...
If no HTML template is defined, then a plain/text email is sent using the txt template. If a HTML template is defined and a text template exists, then the text template will be used as an alternative message.
