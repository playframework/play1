...
bc. application.baseUrl=http://www.playframework.com/
...
bc. #{embeddedImage src:'http://www.playframework.com/assets/images/logo.png', name:'distantImage' /}
...
To use Gmail’s servers, for example when you deploy with "playapps":http://www.playframework.com/modules/playapps, use this configuration: 
