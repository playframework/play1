...
h3. CleanTest Annotation
    ...
    Some tests may need to access or  not to MVC objects:
* Response,
* Request,
* RenderArgs,

By default this object will created and you can directly access to it.
...
In order to control the access to this parameters, you can use the <code>@CleanTest</code> on the test class.
