...
p(note). You can use "Selenium IDE":http://seleniumhq.org/projects/ide/ in order to record test scripts easily. If you do so, you can use the "Selenium IDE plugin for Play":http://manuelbernhardt.github.com/play-selenium-plugin in order to import and export tests using the concise Play! markup.
