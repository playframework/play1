...
p. This module is designed to work with the latest version of GWT. A the moment, it is the 1.6.4 version. Before working with the Play GWT module, you have to download the GWT SDK and set the GWT_PATH environment variable.
