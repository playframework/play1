...
You can customize the way documentation looks by editing @index.html@ file, but it's not mandatory and you can remove it if plain black on white page is ok for you.
