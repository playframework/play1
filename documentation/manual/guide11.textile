...
However it’s kind of unpredictable, and running magical things on a production database is never a good thing. So you should always have a backup before a new deployement. If you don't want that Hibernate updates your database, change the @jpa.ddl@ configuration key to validate:
