...
We will create a form to create a new post. Basically with a form you have 2 actions: one to display the form and one to handle the form submission. Let’s create the new **Admin.form** and **Admin.save** actions that will display and handle form submission:
...
p(note). Here we use render("@form") as a shortcut of render("Admin/form.html"). It just tells Play to use the form action’s default template.
