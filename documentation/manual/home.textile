...
Welcome to the *Play framework 1.3.0* documentation. Check the "version 1.3.0. release notes":releasenotes-1.3.0.
...
These optional modules are included with the standard distribution. "More modules":http://www.playframework.com/modules.
...
# "Play 1.2.7":releasenotes-1.2.7
# "Play 1.2.6":releasenotes-1.2.6
