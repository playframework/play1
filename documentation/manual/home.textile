...
p(note). The 1.1 branch is in active devlopment.

h2. <a name="a">Hot stuff</a>

We will describe here the new features progress

# "Now the future - supporting Scala":scala
# "Some functional programming techniques, brought to Java":lambdaj
...
# "Routes using annotations":router
