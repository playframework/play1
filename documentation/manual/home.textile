...
Welcome to the Play framework documentation. This documentation is intended for the *1.0.2 release* and may significantly differ from previous versions of the framework. Check the "release notes of the 1.0.2 version":releasenotes-1.0.2.
