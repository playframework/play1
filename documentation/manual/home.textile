...
Welcome to the Play framework documentation. This documentation is for the **1.0.3 release**, which differs from previous versions of the framework. Check the "version 1.0.3 release notes":releasenotes-1.0.3 for details.
...
# "Validating HTTP data (form validation)":validation
## "How validation works in Play":validation#how
## "Retrieving validation error messages":validation#messages
## "Displaying validation errors in the template":validation#display
## "Validation annotations":validation#annotations
## "Validating complex objects":validation#objects
