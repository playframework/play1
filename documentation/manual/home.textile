...
Welcome to the play framework documentation. This documentation is intended for the *1.0.2 release* and may significantly differs from previous versions of the framework. Check the "release notes of the 1.0.2 version":releasenotes-1.0.2.
...
# "Play and your application server":applicationserver
## "Packaging your Play application":applicationserver
## "Deploying your Play application":applicationserver
## "Application server compatibility matrix":applicationserver
