...
A date object can be automatically bound if the string representation. Using the @As annotation, you can specify the date format.
...
The calendar binding works exactly as with the date, except that Play! is choosing the Calendar object according to your locale. The @As annotation can also be used.
