...
As you can see this action is pretty simple. We declare the **id** method parameter to automatically retrieve the HTTP **‘id’** parameter as a Long Java object. This parameter will be extracted either from the queryString, from the URL path or from the request body.
