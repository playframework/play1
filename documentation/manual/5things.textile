...
h2. <a>4. Straightforward file upload management</a>
...
h2. <a>5. Distribute an application to several JVMs without configuring anything</a>

Because play is totally stateless, you can just start the same application on several servers and load balance between applications at the HTTP level. No need to set up a complex application server cluster or something similar.