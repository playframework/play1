...
JPA is surely the best ORM API available for Java. If you know it you will be amazed how simpler it becomes with Play. With nothing to configure, Play will automatically start the JPA Entity Manager using Hibernate and magically synchronize it when code is reloaded.
