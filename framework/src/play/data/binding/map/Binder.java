...
import play.data.binding.map.types.DateBinder;
import play.data.binding.map.types.UploadBinder;
import play.data.binding.map.types.ByteArrayBinder;
import play.data.binding.map.types.ByteArrayArrayBinder;
import play.data.binding.map.types.FileBinder;
import play.data.binding.map.types.CalendarBinder;
import play.data.binding.map.types.LocaleBinder;
import play.data.binding.map.types.FileArrayBinder;
import play.data.binding.map.types.UploadArrayBinder;
import play.Logger;
import play.Play;
