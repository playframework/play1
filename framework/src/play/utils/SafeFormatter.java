...
public abstract class SafeFormatter {
    ...
    private static final Pattern formatSpecifier = Pattern
    ...
    public String format(String format, Object... args) {
        ...
        while (matcher.find()) {
            ...
            if (matcher.group(6) != null
                    && (matcher.group(6).equals("n") || matcher.group(6).equals("%"))) {
                ...
                sb.append(appendArgument(newFormatPattern.toString(), args == null ? null
                        : args[index - 1]));
            }
