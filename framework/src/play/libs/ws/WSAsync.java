                    ...
                    try {
                        ...
                        for (String key : this.parameters.keySet()) {
                            ...
                            if (value instanceof Collection<?> || value.getClass().isArray()) {
                                ...
                                for (Object v : values) {
                                    Part part = new ByteArrayPart(key, v.toString().getBytes(encoding), "text/plain", Charset.forName(encoding));
                                    builder.addBodyPart( part );
                                }
                            } else {
                                Part part = new ByteArrayPart(key, value.toString().getBytes(encoding), "text/plain", Charset.forName(encoding));
                                builder.addBodyPart( part );
                            }
                        }
                    } catch(UnsupportedEncodingException e) {
