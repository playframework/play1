...
def execute(**kargs):
    ...
    if is_application:
        replaceAll(os.path.join(app.path, 'eclipse/debug.launch'), r'%PROJECT_NAME%', os.path.basename(app.path))
        ...
        replaceAll(os.path.join(app.path, 'eclipse/test.launch'), r'%PROJECT_NAME%', os.path.basename(app.path))
        ...
        replaceAll(os.path.join(app.path, 'eclipse/connect.launch'), r'%PROJECT_NAME%', os.path.basename(app.path))
