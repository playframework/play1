# perl_codegen.py : perl generator functions for wxTreeCtrl objects
# $Id: perl_codegen.py,v 1.4 2005/08/15 08:04:00 crazyinsomniac Exp $
#
...
def initialize():
    ...
    if plgen:
        plgen.add_widget_handler('wxTreeCtrl', PerlCodeGenerator())
